...
urlpatterns = [
    ...
    path('users/', userviews.get_all_user, name='get_all_user'),
    path('user/<int:id>/', userviews.get_user, name='get_user'),  # Changed user_detail to get_user
    path('user/delete/<int:id>/', userviews.delete_user, name='delete_user'),
    ...
    path('interns/', userviews.get_all_intern, name='get_all_intern'),  # Changed get_all_intern to list_interns
    ...
    path('assign/delete/<int:id>/', userviews.delete_task_assignment, name='delete_task_assignment'),
    path('task/delete/<int:task_id>/', userviews.delete_task, name='delete_task'), 
    path('tasks/', userviews.get_all_task, name='get_all_task'),  
    ...
    path('concerns/', userviews.get_concerns, name='get_concerns'),  # Added get_concerns
    path('concern/<int:id>/', userviews.concern_detail, name='concern_detail'),  # Added get_concerns
